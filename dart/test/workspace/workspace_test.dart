...
void main() {
  group('Workspace Tests', () {
    ...
    test('Workspace with case monitor configuration', () {
      ...
      expect(
        workspace.casesMonitorConfig[0]?.type,
        equals(CaseMonitorCardType.last24Hours),
      );
      expect(
        workspace.casesMonitorConfig[1]?.type,
        equals(CaseMonitorCardType.specificAsset),
      );
    ...
    test('Workspace with table structure', () {
      ...
      expect(
        workspace.tableStructure?.sensorsIds,
        equals(['sensor1', 'sensor2']),
      );
    ...
    test('WorkspaceInput with JSON creation', () {
      ...
      expect(input.color, equals(const Color(0xFF2196F3))); // Colors.blue
    });
