...
void main() {
  group('AppBackgroundDesign Tests', () {
    ...
    test('AppBackgroundDesign with solid color', () {
      ...
      expect(background.mode, equals(BackgroundMode.solid));
      expect(background.color, equals(const Color(0xFF2196F3))); // Colors.blue
    });
    ...
    test(
      'AppBackgroundDesign fromJson with unknown mode defaults to solid',
      () {
        final json = {
          'image': 'test.jpg',
          'mode': 'UNKNOWN_MODE',
  ...
  group('AppBackgroundDesignInput Tests', () {
    ...
    test('AppBackgroundDesignInput with color', () {
      ...
      expect(input.color, equals(const Color(0xFF4CAF50))); // Colors.green
      expect(input.mode, equals(BackgroundMode.solid));
    });
