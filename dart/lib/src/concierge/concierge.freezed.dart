...
/// Is the title of the block. Defaults to an empty string.
 String get name;/// Is the title of the block. Defaults to an empty string.
 set name(String value);/// Is the type of the block. Defaults to [ConciergeFormBlockType.text].
@JsonKey(unknownEnumValue: ConciergeFormBlockType.text) ConciergeFormBlockType get blockType;/// Is the type of the block. Defaults to [ConciergeFormBlockType.text].
@JsonKey(unknownEnumValue: ConciergeFormBlockType.text) set blockType(ConciergeFormBlockType value);/// Is the display condition of the block, or null when the block is always shown.
 ConciergeFormBlockDisplayConditionInput? get showWhen;/// Is the display condition of the block, or null when the block is always shown.
 set showWhen(ConciergeFormBlockDisplayConditionInput? value);/// Is the configuration of the block, or null when not applicable.
 ConciergeFormBlockConfigurationInput? get configuration;/// Is the configuration of the block, or null when not applicable.
...
/// The unique identifier of the concierge form.
 String get id;/// The name of the concierge form.
 String get name;
...
/// Is the title of the page. Defaults to an empty string.
 String get title;/// Is the title of the page. Defaults to an empty string.
 set title(String value);/// Is the blocks (may be fields, headers or paragraph) of the page. Defaults to an empty
/// list.
 List<ConciergeBlockInput> get blocks;/// Is the blocks (may be fields, headers or paragraph) of the page. Defaults to an empty
/// list.
...
/// Indicates if the field can be submitted without value.
 ...
 bool? get isMultiple;/// The maximum value of the field, when it is a number.
 double? get max;/// The minimum value of the field, when it is a number.
 double? get min;/// The list of choices, when the field is a select. Defaults to an empty list.
...
/// Indicates if the field can be submitted without value.
 bool? get allowEmpty;/// Indicates if the field can be submitted without value.
 set allowEmpty(bool? value);/// Indicates if the field is a multiple choice.
 bool? get isMultiple;/// Indicates if the field is a multiple choice.
 set isMultiple(bool? value);/// The minimum value of the field, when it is a number.
 double? get min;/// The minimum value of the field, when it is a number.
 set min(double? value);/// The maximum value of the field, when it is a number.
 double? get max;/// The maximum value of the field, when it is a number.
 set max(double? value);/// Indicates if the field is an integer value or a float value.
 bool? get asInt;/// Indicates if the field is an integer value or a float value.
 set asInt(bool? value);/// The list of choices, when the field is a select.
 List<String>? get choices;/// The list of choices, when the field is a select.
...
/// position of the array.
 int? get blockId;/// The maximum value of the field, or the maximum length of the string value, when the
/// referenced block is a number or string, respectively.
 double? get max;/// The minimum value of the field, or the minimum length of the string value, when the
/// referenced block is a number or string, respectively.
 double? get min;/// Represents the exact value of the field.
 String? get value;/// Represents the validator of the block.
@JsonKey(unknownEnumValue: ConciergeFormDisplayConditionValidator.always) ConciergeFormDisplayConditionValidator get validator;/// Represents the operator used to validate the value.
...
/// Is the reference number of the block inside the same page, in programming terms, is the
/// position of the array.
 int? get blockId;/// Is the reference number of the block inside the same page, in programming terms, is the
/// position of the array.
 set blockId(int? value);/// The minimum value of the field, or the minimum length of the string value, when the
/// referenced block is a number or string, respectively.
 double? get min;/// The minimum value of the field, or the minimum length of the string value, when the
/// referenced block is a number or string, respectively.
 set min(double? value);/// The maximum value of the field, or the maximum length of the string value, when the
/// referenced block is a number or string, respectively.
 double? get max;/// The maximum value of the field, or the maximum length of the string value, when the
/// referenced block is a number or string, respectively.
 set max(double? value);/// Represents the exact value of the field.
 String? get value;/// Represents the exact value of the field.
 set value(String? value);/// Represents the validator of the block. Defaults to
/// [ConciergeFormDisplayConditionValidator.always].
@JsonKey(unknownEnumValue: ConciergeFormDisplayConditionValidator.always) ConciergeFormDisplayConditionValidator get validator;/// Represents the validator of the block. Defaults to
/// [ConciergeFormDisplayConditionValidator.always].
@JsonKey(unknownEnumValue: ConciergeFormDisplayConditionValidator.always) set validator(ConciergeFormDisplayConditionValidator value);/// Represents the operator used to validate the value.
@JsonKey(unknownEnumValue: ConciergeFormDisplayConditionOperator.equals) ConciergeFormDisplayConditionOperator? get validatorOperator;/// Represents the operator used to validate the value.
@JsonKey(unknownEnumValue: ConciergeFormDisplayConditionOperator.equals) set validatorOperator(ConciergeFormDisplayConditionOperator? value);
