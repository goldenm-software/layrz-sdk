...
@JsonKey(unknownEnumValue: OperationMode.unknown) set operationMode(OperationMode value);/// [hasNativeCommands] Boolean that indicates if the protocol has commands though the native comm channel.
 ...
 List<CredentialField> get requiredFields;/// [requiredFields] Required configuration fields.
 set requiredFields(List<CredentialField> value);/// [canFota] Boolean that indicates if the protocol can be updated with FOTA (Firmware over the air).
...
/// 0 means in API and backend services "ignore this field"
 ...
 List<FlespiAcl> get flespiAcl;/// [flespiAcl] refers to the ACL for the token generation.
 set flespiAcl(List<FlespiAcl> value);/// [webhookStructure] defines the specific methods required to handle a complete webhook operation.
 WebhookStructure? get webhookStructure;/// [webhookStructure] defines the specific methods required to handle a complete webhook operation.
 set webhookStructure(WebhookStructure? value);/// [requiresExternalAccount] indicates if the protocol requires an external account to work.
 ...
 List<CommandDefinition> get commandsStructure;/// [commandsStructure] is the structure of the commands for the protocol.
 set commandsStructure(List<CommandDefinition> value);/// [configStructure] is the structure of the configuration for the protocol.
 List<ConfigGrouping> get configStructure;/// [configStructure] is the structure of the configuration for the protocol.
 set configStructure(List<ConfigGrouping> value);/// [confiotCapable] is the boolean that indicates if the protocol is capable of using the Confiot platform.
...
@useResult
$Res call({
 String? id, String name,@ColorConverter() Color color, bool isEnabled, List<String> categoriesIds,@JsonKey(unknownEnumValue: OperationMode.unknown) OperationMode operationMode, bool hasNativeCommands, bool hasSmsCommands, bool hasCommandsResult, int? channelId, bool isFlespi, String? flespiId, bool hasAck, String ackTopicFormat, bool isImported, List<CredentialField> requiredFields, bool canFota, String? host, int? port, String? mqttTopic, AvatarInput dynamicIcon, String? cycleId, bool hasModbus, List<String> modbusPorts, bool requiresFlespiToken, List<FlespiAcl> flespiAcl, WebhookStructure? webhookStructure, bool requiresExternalAccount, bool requiresStructure, List<CommandDefinition> commandsStructure, List<ConfigGrouping> configStructure, bool confiotCapable, String? peripheralIdentifier, Map<String, dynamic>? peripheralParserSpec
});


$AvatarInputCopyWith<$Res> get dynamicIcon;$WebhookStructureCopyWith<$Res>? get webhookStructure;
...
as List<CredentialField>,canFota: null == canFota ? _self.canFota : canFota // ignore: cast_nullable_to_non_nullable
...
/// [flespiAcl] refers to the ACL for the token generation.
@override@JsonKey()  List<FlespiAcl> flespiAcl;
/// [webhookStructure] defines the specific methods required to handle a complete webhook operation.
@override  WebhookStructure? webhookStructure;
/// [requiresExternalAccount] indicates if the protocol requires an external account to work.
@override@JsonKey()  bool requiresExternalAccount;
/// [requiresStructure] indicates if the protocol requires a structure to work.
@override@JsonKey()  bool requiresStructure;
/// [commandsStructure] is the structure of the commands for the protocol.
@override@JsonKey()  List<CommandDefinition> commandsStructure;
/// [configStructure] is the structure of the configuration for the protocol.
@override@JsonKey()  List<ConfigGrouping> configStructure;
/// [confiotCapable] is the boolean that indicates if the protocol is capable of using the Confiot platform.
...
@override $AvatarInputCopyWith<$Res> get dynamicIcon;@override $WebhookStructureCopyWith<$Res>? get webhookStructure;
...
@DynamicMapConverterNullable() Map<String, dynamic>? get credentials;/// [externalAccountId] is the ID of the external account.
 String? get externalAccountId;/// [updateTime] is the update time of the service.
@DurationOrNullConverter() Duration? get updateTime;/// [protocol] is the protocol entity.
 InboundProtocol? get protocol;/// [protocolId] is the protocol ID.
 String? get protocolId;/// [isEnabled] is the current transmission status.
 bool? get isEnabled;/// [token] is the token to authenticate the request, only used for Alpha REST inbound protocol.
 String? get token;/// [structure] is the structure of the inbound protocol, only used for Omega REST inbound protocol.
 InboundStructure? get structure;/// [access] is a list of custom access permissions.
...
class _ConfIoTFile extends ConfIoTFile {
