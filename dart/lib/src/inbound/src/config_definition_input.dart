...
/// [ConfigDefinitionInput] is the mutable, input counterpart of [ConfigDefinition].
///
/// It is used when building or editing a configuration parameter, for example in a form,
