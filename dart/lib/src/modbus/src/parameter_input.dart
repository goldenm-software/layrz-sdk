...
/// [ModbusParameterInput] is the input variant of [ModbusParameter].
@unfreezed
abstract class ModbusParameterInput with _$ModbusParameterInput {
  const ModbusParameterInput._();

  /// Constructs a mutable [ModbusParameterInput].
  ...
  /// Deserializes a [ModbusParameterInput] from a JSON map.
