...
/// Immutable command definition executable on a [Device].
@freezed
abstract class DeviceCommand with _$DeviceCommand {
  const DeviceCommand._();

  /// Constructs an immutable [DeviceCommand].
  ...
  /// Deserializes a [DeviceCommand] from a JSON map.
  ...
  static Future<List<DeviceCommand>> fetchAll({
    ...
    try {
      ...
      if (response.status != .ok) {
        Log.error(
          "layrz_sdk/DeviceCommand/fetchAll(): Error fetching all DeviceCommand entities: ${response.status}",
        );
      ...
      Log.critical("layrz_sdk/DeviceCommand/fetchAll(): Error fetching all DeviceCommand entities: $err\n$trace");
  ...
  Future<DeviceCommand?> fetch({
    ...
    try {
      ...
      if (response.status != .ok) {
        Log.error("layrz_sdk/DeviceCommand/fetch(): Error fetching DeviceCommand entity: ${response.status}");
        onResponse?.call(response.status);
        return null;
      }
      ...
      Log.critical("layrz_sdk/DeviceCommand/fetch(): Error fetching DeviceCommand entity: $err\n$trace");
      onResponse?.call(.internalError);
      return null;
    }
  }
  ...
  Future<bool> delete({
    ...
    try {
      ...
      if (response.status != .ok) {
        Log.error("layrz_sdk/DeviceCommand/delete(): Error deleting DeviceCommand entity: ${response.status}");
        onResponse?.call(response.status);
        return false;
      }
      ...
      Log.critical("layrz_sdk/DeviceCommand/delete(): Error deleting DeviceCommand entity: $err\n$trace");
      onResponse?.call(.internalError);
      return false;
    }
  }
  ...
  static Future<bool> deleteMany({
    ...
    try {
      ...
      if (response.status != .ok) {
        Log.error("layrz_sdk/DeviceCommand/deleteMany(): Error deleting DeviceCommand entities: ${response.status}");
        onResponse?.call(response.status);
        return false;
      }
      ...
      Log.critical("layrz_sdk/DeviceCommand/deleteMany(): Error deleting DeviceCommand entities: $err\n$trace");
      onResponse?.call(.internalError);
      return false;
    }
  }
  ...
  Future<bool> execute({
    ...
    try {
      ...
      if (response.status != .ok) {
        Log.error("layrz_sdk/DeviceCommand/execute(): Error executing DeviceCommand entity: ${response.status}");
        onResponse?.call(response.status);
        return false;
      }
      ...
      Log.critical("layrz_sdk/DeviceCommand/execute(): Error executing DeviceCommand entity: $err\n$trace");
      onResponse?.call(.internalError);
      return false;
    }
  }
