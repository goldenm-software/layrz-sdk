...
/// The ecosystem variant a [Geofence] operation targets.
///
/// [GeofenceVariant] selects which GraphQL query/mutation names are used when
/// fetching, saving, or deleting geofences, since the standard, Mappit, and
/// ATS ecosystems expose the same shape under different operation names.
