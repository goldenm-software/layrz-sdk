...
Map<String, dynamic> _$RegisteredAppToJson(
  ...
  'importedAssets': instance.importedAssets?.map((e) => e.toJson()).toList(),
  'importedDevices': instance.importedDevices?.map((e) => e.toJson()).toList(),
  'importedUsers': instance.importedUsers?.map((e) => e.toJson()).toList(),
  'keychain': instance.keychain?.map((e) => e.toJson()).toList(),
  'sourceId': instance.sourceId,
  'owner': instance.owner?.toJson(),
  'allowedReports': instance.allowedReports?.map((e) => e.toJson()).toList(),
...
_AppDesign _$AppDesignFromJson(Map<String, dynamic> json) => _AppDesign(
  mainColor: const ColorOrNullConverter().fromJson(
    json['mainColor'] as String?,
  ),
...
_AppDesignInput _$AppDesignInputFromJson(
  Map<String, dynamic> json,
) => _AppDesignInput(
  theme:
      $enumDecodeNullable(
  ...
  logos: AppThemedAssetInput.fromJson(json['logos'] as Map<String, dynamic>),
  login: AppLoginDesignInput.fromJson(json['login'] as Map<String, dynamic>),
  titleFont: AppFontInput.fromJson(json['titleFont'] as Map<String, dynamic>),
...
_AppLoginDesign _$AppLoginDesignFromJson(Map<String, dynamic> json) =>
    _AppLoginDesign(
      backgroundColor: const ColorOrNullConverter().fromJson(
      ...
      design: $enumDecodeNullable(
        _$LayoutDesignEnumMap,
        json['design'],
...
Map<String, dynamic> _$AppLoginDesignToJson(_AppLoginDesign instance) =>
    <String, dynamic>{
      'backgroundColor': const ColorOrNullConverter().toJson(
...
Map<String, dynamic> _$AppThemedAssetToJson(_AppThemedAsset instance) =>
    <String, dynamic>{'normal': instance.normal, 'white': instance.white};
...
_AppVersion _$AppVersionFromJson(Map<String, dynamic> json) => _AppVersion(
  ...
  buildNumber: (json['buildNumber'] as num).toInt(),
  buildName: json['buildName'] as String,
  releasedAt: const TimestampConverter().fromJson(json['releasedAt'] as num),
);
