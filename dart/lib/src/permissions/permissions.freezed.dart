...
/// Permission to read or view module entities. Defaults to `false`.
 bool get read;/// Permission to modify existing module entities. Defaults to `false`.
 bool get write;/// Permission to create new entities in the module. Defaults to `false`.
 bool get create;/// Permission to delete or remove entities from the module.
/// Defaults to `false`.
 bool get delete;/// Permission to plan or schedule operations on module entities.
/// Defaults to `false`.
 bool get plan;/// Permission to log in as a user within this module context.
/// Defaults to `false`.
 bool get loginas;/// Permission to suspend or temporarily disable entities.
/// Defaults to `false`.
 bool get suspend;
...
/// Permission to read or view module entities. Defaults to `false`.
 bool get read;/// Permission to read or view module entities. Defaults to `false`.
 set read(bool value);/// Permission to modify existing module entities. Defaults to `false`.
 bool get write;/// Permission to modify existing module entities. Defaults to `false`.
 set write(bool value);/// Permission to create new entities in the module. Defaults to `false`.
 bool get create;/// Permission to create new entities in the module. Defaults to `false`.
 set create(bool value);/// Permission to delete or remove entities from the module.
/// Defaults to `false`.
 bool get delete;/// Permission to delete or remove entities from the module.
/// Defaults to `false`.
 set delete(bool value);/// Permission to plan or schedule operations on module entities.
/// Defaults to `false`.
 bool get plan;/// Permission to plan or schedule operations on module entities.
/// Defaults to `false`.
 set plan(bool value);/// Permission to log in as a user within this module context.
/// Defaults to `false`.
 bool get loginas;/// Permission to log in as a user within this module context.
/// Defaults to `false`.
 set loginas(bool value);/// Permission to suspend or temporarily disable entities.
/// Defaults to `false`.
 bool get suspend;/// Permission to suspend or temporarily disable entities.
/// Defaults to `false`.
 set suspend(bool value);
...
/// Permission item for the apps module, or null if not assigned.
 GenericPermissionItem? get apps;/// Permission item for the users module, or null if not assigned.
 GenericPermissionItem? get users;/// Permission item for the firmwares module, or null if not assigned.
 GenericPermissionItem? get firmwares;/// Permission item for the employees module, or null if not assigned.
 GenericPermissionItem? get employees;/// Permission item for the languages module, or null if not assigned.
 GenericPermissionItem? get languages;/// Permission item for the categories module, or null if not assigned.
 GenericPermissionItem? get categories;/// Permission item for the departments module, or null if not assigned.
 GenericPermissionItem? get departments;/// Permission item for the protocols module, or null if not assigned.
 GenericPermissionItem? get protocols;/// Permission item for the billing module, or null if not assigned.
 GenericPermissionItem? get billing;/// Permission item for the cycles module, or null if not assigned.
 GenericPermissionItem? get cycles;/// Permission item for the shortcuts module, or null if not assigned.
 GenericPermissionItem? get shortcuts;/// Permission item for the layers module, or null if not assigned.
...
/// Permission item for the apps module.
 GenericPermissionItemInput get apps;/// Permission item for the apps module.
 set apps(GenericPermissionItemInput value);/// Permission item for the users module.
 GenericPermissionItemInput get users;/// Permission item for the users module.
 set users(GenericPermissionItemInput value);/// Permission item for the firmwares module.
 GenericPermissionItemInput get firmwares;/// Permission item for the firmwares module.
 set firmwares(GenericPermissionItemInput value);/// Permission item for the employees module.
 GenericPermissionItemInput get employees;/// Permission item for the employees module.
 set employees(GenericPermissionItemInput value);/// Permission item for the languages module.
 GenericPermissionItemInput get languages;/// Permission item for the languages module.
 set languages(GenericPermissionItemInput value);/// Permission item for the categories module.
 GenericPermissionItemInput get categories;/// Permission item for the categories module.
 set categories(GenericPermissionItemInput value);/// Permission item for the departments module.
 GenericPermissionItemInput get departments;/// Permission item for the departments module.
 set departments(GenericPermissionItemInput value);/// Permission item for the protocols module.
 GenericPermissionItemInput get protocols;/// Permission item for the protocols module.
 set protocols(GenericPermissionItemInput value);/// Permission item for the billing module.
 GenericPermissionItemInput get billing;/// Permission item for the billing module.
 set billing(GenericPermissionItemInput value);/// Permission item for the cycles module.
 GenericPermissionItemInput get cycles;/// Permission item for the cycles module.
 set cycles(GenericPermissionItemInput value);/// Permission item for the shortcuts module.
 GenericPermissionItemInput get shortcuts;/// Permission item for the shortcuts module.
 set shortcuts(GenericPermissionItemInput value);/// Permission item for the layers module.
 GenericPermissionItemInput get layers;/// Permission item for the layers module.
 set layers(GenericPermissionItemInput value);
