...
/// If you want to use the Layrz Translation system, please set the [titleTranslate] to enable it.
 String get title;/// [titleTranslate] is the key to use the Layrz Translation system for the title.
 bool get titleTranslate;/// [titleArgs] is the list of arguments to use with the Layrz Translation system for the title.
///
/// If [titleTranslate] is `false`, this field will be ignored.
 Map<String, dynamic> get titleArgs;/// [message] is the body of the notification.
///
/// If you want to use the Layrz Translation system, please set the [messageTranslate] to enable it.
 String get message;/// [messageTranslate] is the key to use the Layrz Translation system for the message.
 bool get messageTranslate;/// [messageArgs] is the list of arguments to use with the Layrz Translation system for the message.
///
/// If [messageTranslate] is `false`, this field will be ignored.
 Map<String, dynamic> get messageArgs;/// [sound] is the sound effect to play when the notification arrives.
 SoundEffect get sound;/// [icon] is the icon to display with the notification.
...
/// This will only be considered if the [sound] is set to `SoundEffect.custom`.
 String? get uri;/// [duration] is the duration of the notification.
@DurationConverter() Duration get duration;
/// Create a copy of LayrzNotification
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LayrzNotificationCopyWith<LayrzNotification> get copyWith => _$LayrzNotificationCopyWithImpl<LayrzNotification>(this as LayrzNotification, _$identity);
...
@useResult
$Res call({
 String title, bool titleTranslate, Map<String, dynamic> titleArgs, String message, bool messageTranslate, Map<String, dynamic> messageArgs, SoundEffect sound,@IconOrNullConverter() MdiRemapIcon? icon,@ColorConverter() Color color, String? uri,@DurationConverter() Duration duration
});
...
/// Create a copy of LayrzNotification
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? titleTranslate = null,Object? titleArgs = null,Object? message = null,Object? messageTranslate = null,Object? messageArgs = null,Object? sound = null,Object? icon = freezed,Object? color = null,Object? uri = freezed,Object? duration = null,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LayrzNotification value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LayrzNotification value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LayrzNotification value)?  $default,){
final _that = this;
switch (_that) {
case _LayrzNotification() when $default != null:
return $default(_that);case _:
...
class _LayrzNotification extends LayrzNotification {
  const _LayrzNotification({required this.title, this.titleTranslate = false, this.titleArgs = const {}, required this.message, this.messageTranslate = false, this.messageArgs = const {}, this.sound = SoundEffect.none, @IconOrNullConverter() this.icon, @ColorConverter() this.color = const Color(0xFF2196F3), this.uri, @DurationConverter() this.duration = const Duration(seconds: 5)}): super._();
...
@override@JsonKey() final  bool titleTranslate;
...
@override@JsonKey() final  bool messageTranslate;
...
@override@JsonKey() final  SoundEffect sound;
...
@pragma('vm:prefer-inline')
_$LayrzNotificationCopyWith<_LayrzNotification> get copyWith => __$LayrzNotificationCopyWithImpl<_LayrzNotification>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LayrzNotificationToJson(this, );
}
...
/// @nodoc
abstract mixin class _$LayrzNotificationCopyWith<$Res> implements $LayrzNotificationCopyWith<$Res> {
...
/// Create a copy of LayrzNotification
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? titleTranslate = null,Object? titleArgs = null,Object? message = null,Object? messageTranslate = null,Object? messageArgs = null,Object? sound = null,Object? icon = freezed,Object? color = null,Object? uri = freezed,Object? duration = null,}) {
