...
/// The unique identifier for this user.
 String get id;/// The display name of the user.
 String get name;/// The email address associated with the user account, or null if not set.
 String? get email;/// The username (login handle) for the user, or null if not set.
 String? get username;/// The user's [Department] object, or null if no department is assigned.
 Department? get department;/// The unique identifier of the user's department, or null if not assigned.
 String? get departmentId;/// The user's [Avatar] (profile picture), or null if not configured.
 Avatar? get dynamicAvatar;/// The user's authentication [Token], or null if not applicable.
 Token? get token;/// System-assigned permissions for platform modules via [GenericPermission],
/// or null if not configured.
 GenericPermission? get permissions;/// Custom role-based permissions for platform modules via [GenericPermission],
/// or null if not configured.
 GenericPermission? get customPermissions;/// Whether multi-factor authentication (MFA) is enabled for this user.
/// Defaults to false.
 bool get mfaEnabled;/// List of [MfaMethod] instances registered for this user.
/// Defaults to an empty list.
 List<MfaMethod> get mfaMethods;/// User-specific preferences (theme, language, accessibility settings) via
/// [UserPreferences], or null if not configured.
 UserPreferences? get preferences;/// List of [Passkey] (WebAuthn/FIDO2) credentials registered for this user.
/// Defaults to an empty list.
...
/// The unique identifier for the user, optional (system-assigned on create).
 String? get id;/// The unique identifier for the user, optional (system-assigned on create).
 set id(String? value);/// The display name of the user. Defaults to empty string.
 String get name;/// The display name of the user. Defaults to empty string.
 set name(String value);/// The email address for the user. Defaults to empty string.
 String get email;/// The email address for the user. Defaults to empty string.
 set email(String value);/// The username (login handle) for the user. Defaults to empty string.
 String get username;/// The username (login handle) for the user. Defaults to empty string.
 set username(String value);/// The unique identifier of the department to assign to this user, or null
/// if not assigning a department.
 String? get departmentId;/// The unique identifier of the department to assign to this user, or null
/// if not assigning a department.
 set departmentId(String? value);/// The avatar (profile picture) for the user via [AvatarInput], or null if
