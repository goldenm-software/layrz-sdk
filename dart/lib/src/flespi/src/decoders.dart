...
/// Decodes a raw GraphQL list response into a list of [FlespiProtocol].
...
/// Decodes a raw GraphQL list response into a list of [FlespiChannel].
...
/// Decodes a raw GraphQL list response into a list of [FlespiModel].
