...
/// [FlespiProtocol] represents a device protocol supported by the Flespi
/// platform.
@freezed
  ...
  static Future<List<FlespiProtocol>> fetchAll({
    ...
    try {
      ...
      if (response.status != .ok) {
        Log.warning('layrz_sdk/FlespiProtocol/fetchAll(): API returned status ${response.status}');
      ...
      Log.critical('layrz_sdk/FlespiProtocol/fetchAll(): Error fetching protocols: $err\n$stack');
