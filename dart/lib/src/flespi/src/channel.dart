...
/// [FlespiChannel] represents a connection channel on the Flespi platform
/// that a device communicates through.
@freezed
  ...
  static Future<List<FlespiChannel>> fetchAll({
    ...
    try {
      ...
      if (response.status != .ok) {
        Log.warning('layrz_sdk/FlespiChannel/fetchAll(): API returned status ${response.status}');
      ...
      Log.critical('layrz_sdk/FlespiChannel/fetchAll(): Error fetching protocols: $err\n$stack');
