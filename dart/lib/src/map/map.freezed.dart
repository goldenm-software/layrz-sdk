...
/// Unique identifier for this layer, or null when creating a new one.
 String? get id;/// Unique identifier for this layer, or null when creating a new one.
 set id(String? value);/// The name of the layer. Defaults to an empty string.
 String get name;/// The name of the layer. Defaults to an empty string.
 set name(String value);/// The tile provider this layer draws its background from. Defaults to
/// [MapSource.custom].
@JsonKey(unknownEnumValue: MapSource.custom) MapSource get source;/// The tile provider this layer draws its background from. Defaults to
/// [MapSource.custom].
@JsonKey(unknownEnumValue: MapSource.custom) set source(MapSource value);/// The raster server URL for light mode and default rendering.
///
/// Only used when [source] is [MapSource.custom].
 String? get rasterServerLight;/// The raster server URL for light mode and default rendering.
///
/// Only used when [source] is [MapSource.custom].
 set rasterServerLight(String? value);/// The raster server URL for dark mode.
///
/// Only used when [source] is [MapSource.custom].
 String? get rasterServerDark;/// The raster server URL for dark mode.
///
/// Only used when [source] is [MapSource.custom].
 set rasterServerDark(String? value);/// The Google Maps token with Map Tiles API capabilities.
///
/// Only used when [source] is [MapSource.google].
 String? get googleToken;/// The Google Maps token with Map Tiles API capabilities.
///
/// Only used when [source] is [MapSource.google].
 set googleToken(String? value);/// The list of enabled Google Maps layers.
///
/// Only used when [source] is [MapSource.google].
@JsonKey(unknownEnumValue: GoogleMapLayer.roadmap) List<GoogleMapLayer>? get googleLayers;/// The list of enabled Google Maps layers.
///
/// Only used when [source] is [MapSource.google].
@JsonKey(unknownEnumValue: GoogleMapLayer.roadmap) set googleLayers(List<GoogleMapLayer>? value);/// The Mapbox token with Static Tiles API capabilities.
///
/// Only used when [source] is [MapSource.mapbox].
 String? get mapboxToken;/// The Mapbox token with Static Tiles API capabilities.
///
/// Only used when [source] is [MapSource.mapbox].
 set mapboxToken(String? value);/// The list of enabled Mapbox styles for the layer.
///
/// Only used when [source] is [MapSource.mapbox].
@JsonKey(unknownEnumValue: MapboxStyle.navigation) List<MapboxStyle>? get mapboxLayers;/// The list of enabled Mapbox styles for the layer.
///
/// Only used when [source] is [MapSource.mapbox].
@JsonKey(unknownEnumValue: MapboxStyle.navigation) set mapboxLayers(List<MapboxStyle>? value);/// The Mapbox custom username.
///
/// Only used when [source] is [MapSource.mapbox] and [mapboxLayers]
/// contains [MapboxStyle.custom].
 String? get mapboxCustomUsername;/// The Mapbox custom username.
///
/// Only used when [source] is [MapSource.mapbox] and [mapboxLayers]
/// contains [MapboxStyle.custom].
 set mapboxCustomUsername(String? value);/// The Mapbox custom style id.
///
/// Only used when [source] is [MapSource.mapbox] and [mapboxLayers]
/// contains [MapboxStyle.custom].
 String? get mapboxCustomStyleId;/// The Mapbox custom style id.
///
/// Only used when [source] is [MapSource.mapbox] and [mapboxLayers]
/// contains [MapboxStyle.custom].
 set mapboxCustomStyleId(String? value);/// The HERE token with Map Tiles API capabilities.
///
/// Only used when [source] is [MapSource.here].
 String? get hereToken;/// The HERE token with Map Tiles API capabilities.
///
/// Only used when [source] is [MapSource.here].
 set hereToken(String? value);/// The list of enabled HERE Maps styles.
///
/// Only used when [source] is [MapSource.here].
@JsonKey(unknownEnumValue: HereStyle.lite) List<HereStyle>? get hereLayers;/// The list of enabled HERE Maps styles.
///
/// Only used when [source] is [MapSource.here].
@JsonKey(unknownEnumValue: HereStyle.lite) set hereLayers(List<HereStyle>? value);/// The URI for the attribution logo shown over the layer.
 String get attributionUrl;/// The URI for the attribution logo shown over the layer.
 set attributionUrl(String value);/// The URI for the attribution logo shown over the layer in dark mode.
 String? get attributionUrlDark;/// The URI for the attribution logo shown over the layer in dark mode.
 set attributionUrlDark(String? value);/// The width of the attribution logo, in logical pixels.
 double get attributionWidth;/// The width of the attribution logo, in logical pixels.
 set attributionWidth(double value);/// The height of the attribution logo, in logical pixels.
 double get attributionHeight;/// The height of the attribution logo, in logical pixels.
 set attributionHeight(double value);/// The list of app ids this layer is associated with.
 List<String> get appsIds;/// The list of app ids this layer is associated with.
