...
/// The external-account API variant to target.
///
/// [ExternalAccountVariant] selects which set of GraphQL query and mutation
/// names [ExternalAccount] callers use: the [standard] external-account API,
/// or the [mappit] variant used for Mappit-sourced external accounts.
