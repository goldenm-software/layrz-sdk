...
/// [ApiStatus.unauthorized]).
 ApiStatus get status;/// Optional error payload, typically a map of error details from the
/// server. Null on success.
 Q? get errors;/// Optional result payload, containing the operation's data on success.
/// Null on failure.
 T? get result;
