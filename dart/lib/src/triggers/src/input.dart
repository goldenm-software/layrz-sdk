...
/// Mutable trigger input used to create or update a [Trigger].
///
/// assetsIds [ID]
...
///
/// exactHour String
/// Mode of activation / disparator for TriggerType.exactTime, please read the documentation of TriggerType for
/// more information about the activation modes.
///
/// formula String
/// Layrz Language formula
///
/// geofenceKind TriggerGeofenceDetectionMode
/// Mode of activation / disparator for TriggerType.presenceInGeofences, please read the documentation of
/// TriggerType for more information about the activation modes.
///
/// geofencesIds [ID]
...
///
/// kind TriggerType
/// Mode of activation, please read the documentation of TriggerType for more information about the activation
/// modes.
///
/// name String
/// Name of the trigger.
...
///
/// visualEventEffect CaseEventEffect
...
abstract class TriggerInput with _$TriggerInput {
  /// Constructs a mutable [TriggerInput].
  factory TriggerInput({
    ...
    @ColorConverter() @Default(Color(0xFFF44336)) Color color,

    /// Visual event effects to use in Monitor Center events received.
    @JsonKey(unknownEnumValue: CaseEventEffect.none)
    @Default(CaseEventEffect.none)
  ...
  /// Deserializes a [TriggerInput] from a JSON map.
