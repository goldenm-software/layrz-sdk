...
_Asset _$AssetFromJson(Map<String, dynamic> json) => _Asset(
  ...
  linkedSupplyPointAssets: (json['linkedSupplyPointAssets'] as List<dynamic>?)
      ?.map((e) => Asset.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$AssetToJson(_Asset instance) => <String, dynamic>{
  ...
  'authenticatedAssets': instance.authenticatedAssets
      ?.map((e) => e.toJson())
      .toList(),
  'authenticatedUsersIds': instance.authenticatedUsersIds,
  'authenticatedUsers': instance.authenticatedUsers
      ?.map((e) => e.toJson())
      .toList(),
  ...
  'mappitLaborHours': instance.mappitLaborHours
      ?.map((e) => e.toJson())
      .toList(),
  ...
  'linkedSupplyPointAssets': instance.linkedSupplyPointAssets
      ?.map((e) => e.toJson())
      .toList(),
...
_AssetInput _$AssetInputFromJson(Map<String, dynamic> json) => _AssetInput(
  ...
  contacts:
      (json['contacts'] as List<dynamic>?)
          ...
          .toList() ??
      const [],
  connection: ConnectionInput.fromJson(
  ...
  authenticatedUsersIds:
      (json['authenticatedUsersIds'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  authenticatedAssetsIds:
      (json['authenticatedAssetsIds'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  externalIdentifiers:
      ...
      const [],
  devicesIds:
      (json['devicesIds'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  childrenIds:
  ...
  loginInfo: json['loginInfo'] == null
      ? null
      : AssetLoginInfoInput.fromJson(json['loginInfo'] as Map<String, dynamic>),
  points: (json['points'] as List<dynamic>?)
  ...
  authenticationCardNfcId: json['authenticationCardNfcId'] as String?,
  mappitLaborHours:
      (json['mappitLaborHours'] as List<dynamic>?)
          ?.map((e) => MappitLaborHourInput.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
...
Map<String, dynamic> _$AssetInputToJson(
  _AssetInput instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  'kindId': instance.kindId,
...
_Connection _$ConnectionFromJson(Map<String, dynamic> json) => _Connection(
  ...
  hibernation: const DurationOrNullConverter().fromJson(
    json['hibernation'] as num?,
  ),
);

Map<String, dynamic> _$ConnectionToJson(
  _Connection instance,
) => <String, dynamic>{
  'online': const DurationOrNullConverter().toJson(instance.online),
  'hibernation': const DurationOrNullConverter().toJson(instance.hibernation),
};
