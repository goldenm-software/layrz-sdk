...
abstract class Model with _$Model {
  ...
  static Future<List<Model>> fetchAll({
    ...
    try {
      ...
      Log.critical("layrz_sdk/Model/fetchAll(): Error getting models: $err\n$stack");
  ...
  Future<Model?> fetch({
    ...
    try {
      ...
      Log.critical("layrz_sdk/Model/fetch(): Error getting model $id: $err\n$stack");
      onResponse?.call(.internalError);
      return null;
    }
  }
...
/// [_modelListDecoder] decodes a raw listing `result` payload into a list of [Model].
/// Used by listing queries (fetchAll and single-item fetch, list-first decoding).
