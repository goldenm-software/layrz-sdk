...
/// Mutable payload parameter input used to build or edit a [CommandDefinitionInput]'s payload shape.
@unfreezed
abstract class CommandPayloadDefinitionInput with _$CommandPayloadDefinitionInput {
  /// Constructs a mutable [CommandPayloadDefinitionInput].
  ...
  /// Deserializes a [CommandPayloadDefinitionInput] from a JSON map.
