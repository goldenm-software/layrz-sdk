...
class AtsPurchaseOrder(BaseModel):
  ...
  category: OrderCategories | None = Field(description='Category of the operation')
  deliver_category: DeliveryCategories | None = Field(description='Delivery category of the operation')
  seller_asset_id: int = Field(description='ID of the seller asset')
  transport_asset_id: int | None = Field(description='ID of the transport asset')
  asset_id: int = Field(description='ID of the asset')
  delivered_at: datetime | None = Field(description='Timestamp when the operation was delivered')
  eta: datetime | None = Field(description='Estimated time of arrival to the destination')
  eta_updated_at: datetime | None = Field(description='Timestamp when the ETA was last updated')
  invoice_type: str = Field(description='Type of the invoice')
  operation_id: int | None = Field(description='ID of the operation')
