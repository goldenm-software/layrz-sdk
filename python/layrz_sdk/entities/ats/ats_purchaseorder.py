...
class OrderStatus(StrEnum):
  ...
  LOADING_BOOKED = 'LOADING_BOOKED'
  UNLOADING_BOOKED = 'UNLOADING_BOOKED'

  VALIDATED = 'VALIDATED'

  NFE_CHANGED = 'NFE_CHANGED'  # For orders with NF-e, when the NF-e is changed after the order is created

  TERMINAL_ENTRY = 'TERMINAL_ENTRY'
  TERMINAL_EXIT = 'TERMINAL_EXIT'

  REDISPATCHED = 'REDISPATCHED'
  MDFE_CONSOLIDATED = 'MDFE_CONSOLIDATED'
  CTE_OPERATION_MERGED = 'CTE_OPERATION_MERGED'
...
class OrderCategories(StrEnum):
  ...
  PRODUCTION_SALE_TO_FREE_TRADE_ZONE = 'PRODUCTION_SALE_TO_FREE_TRADE_ZONE'
  SALE_FROM_THIRD_PARTY_TANK = 'SALE_FROM_THIRD_PARTY_TANK'
  SALE_FROM_THIRD_PARTY_DELIVERED_BY_SELLER = 'SALE_FROM_THIRD_PARTY_DELIVERED_BY_SELLER'
  REMITTANCE_SALE = 'REMITTANCE_SALE'
